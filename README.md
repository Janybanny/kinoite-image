# Janybanny/kinoite-image (BlueBuild Template) &nbsp; [![build-ublue](https://github.com/blue-build/template/actions/workflows/build.yml/badge.svg)](https://github.com/blue-build/template/actions/workflows/build.yml)
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/Janybanny/kinoite-image:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/Janybanny/kinoite-image:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/Janybanny/kinoite-image
```
